...
# FROM OLD MYCONFIG.PY FILE (D4/myconfig.py)
# import os
# 
# #PATHS
...
JOYSTICK_STEERING_SCALE = 0.5       #some people want a steering that is less$
...
JOYSTICK_STEERING_SCALE = 0.7       #some people want a steering that is less sensitve. This scalar is multiplied with the steering -1 to 1. It can be negative to reverse dir.
...
# OLD MYCONFIG.PY FILE (d5/myconfig.py)
# import os
# 
# 
# import os
...
PATH_MIN_DIST = 3                 # after travelling this distance (m), save a path point
# PATH_SEARCH_LENGTH = None           # number of points to search for closest point, None to search entire path
PATH_LOOK_AHEAD = 2                # number of points ahead of the closest point to include in cte track
# PATH_LOOK_BEHIND = 1                # number of points behind the closest point to include in cte track   
PID_P = 0.15                       # proportional mult for PID path follower
PID_I = 0.0                       # integral mult for PID path follower
PID_D = 0.06                        # differential mult for PID path follower
PID_THROTTLE = 0.5                 # constant throttle value during path following
PID_D_DELTA = 0.01                  # amount the inc/dec function will change the D value
PID_P_DELTA = 0.05                  # amount the inc/dec function will change the P value
# 
# #
