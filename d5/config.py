...
LOAD_PATH_BTN = "A"             # button (re)load path
RESET_ORIGIN_BTN = "Y"     # button to press to move car back to origin
ERASE_PATH_BTN = "B"     # button to erase path
TOGGLE_RECORDING_BTN = "back" # button to toggle recording mode
INC_PID_D_BTN = "R2_pressure"            # button to change PID 'D' constant by PID_D_DELTA
DEC_PID_D_BTN = "L2_pressure"            # button to change PID 'D' constant by -PID_D_DELTA
INC_PID_P_BTN = "R1"            # button to change PID 'P' constant by PID_P_DELTA
DEC_PID_P_BTN = "L1"            # button to change PID 'P' constant by -PID_P_DELTA
