...
while True:
    ...
    if len(hands) > 0:
        f = open("/home/jetson/projects/finalproject/comm.txt", "w")
        if hands[0].gesture == "STOP":
             last = "STOP"
             f.write("STOP")
        elif hands[0].gesture == "GO":
             last = "GO"
             f.write("GO")
        f.close()
    ...
    #     elif hands[0].gesture == "GO":
    #         last = "GO"
    #         VESC.run(vesc, 0, speed)
    #     elif hands[0].gesture == "LEFT":
    #         last = "LEFT"
    #         VESC.run(vesc, -1, speed)
