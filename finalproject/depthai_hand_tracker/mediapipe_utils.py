...
def recognize_gesture(hand):           
    ...
    # index and middle
    d_7_11 = distance(hand.norm_landmarks[7], hand.norm_landmarks[11])
    d_6_7 = distance(hand.norm_landmarks[6], hand.norm_landmarks[7])
    # middle and ring
    d_11_15 = distance(hand.norm_landmarks[11], hand.norm_landmarks[15])
    d_10_11 = distance(hand.norm_landmarks[10], hand.norm_landmarks[11])
    # ring and little
    d_15_20 = distance(hand.norm_landmarks[15], hand.norm_landmarks[20]) 
    d_14_15 = distance(hand.norm_landmarks[14], hand.norm_landmarks[15])
    #Thumb Angles
    ...
    closed = (d_3_5 / d_2_3 < 1.2 and d_7_11 / d_6_7 < 1.2 and d_11_15 / d_10_11 < 1.2 and d_15_20 / d_14_15 < 1.2)
    ...
    # Gesture
    if hand.rotation < 0.5 and hand.rotation > -0.5 and closed and hand.thumb_state == 1 and hand.index_state == 1 and hand.middle_state == 1 and hand.ring_state == 1 and hand.little_state == 1:
        hand.gesture = "STOP"
    ...
    #    hand.gesture = "PEACE"
    elif hand.rotation < -1.2 and hand.rotation > -1.8 and hand.thumb_state == 1 and hand.index_state == 1 and hand.middle_state == 0 and hand.ring_state == 0 and hand.little_state == 0:
        hand.gesture = "LEFT"
    elif hand.rotation > 1.2 and hand.rotation < 1.8 and hand.thumb_state == 1 and hand.index_state == 1 and hand.middle_state == 0 and hand.ring_state == 0 and hand.little_state == 0:
        hand.gesture = "RIGHT"
